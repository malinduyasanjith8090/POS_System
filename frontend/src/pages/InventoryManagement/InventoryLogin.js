...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (username === 'inventoryadmin' && password === '1234') {
      navigate('/inventory/dashobard'); // Navigate to dashboard after successful login
    } else {
  ...
  return (
    ...
    <div style={styles.container}>
      <div style={styles.formContainer}>
        <h2 style={styles.title}>Inventory Admin Login</h2>
