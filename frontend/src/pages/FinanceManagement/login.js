...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (username === 'financeadmin' && password === '1234') {
      navigate('/finance/dashboard'); // Navigate to dashboard after successful login
    } else {
  ...
  return (
    ...
    <div style={titleBarStyle}>
        <h1 style={{ margin: 0, padding: 0 }}>Finance Management</h1>
      </div>
    <div style={styles.container}>
      <div style={styles.formContainer}>
        <h2 style={styles.title}>Finance Admin Login</h2>
